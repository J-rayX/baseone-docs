...
You can follow the steps on how to [configure the webhook URL](https://developer.baseone.co/docs/webhooks#how-to-register-your-webhook-url-on-the-baseone-dashboard) in your BaseOne dashboard **Developer** settings. 
